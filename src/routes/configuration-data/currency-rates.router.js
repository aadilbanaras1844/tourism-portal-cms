...
const { currencyRatesService } = require("../../services");
...
router.post('/', async function(req, res, next){
    ...
    try {
        let result= await currencyRatesService.create( params );
...
router.post('/:id', async function(req, res, next){
    ...
    let params = req.body;
    try {
        let result = await currencyRatesService.update( id, params );
...
router.delete('/:id', async  function(req, res, next){
    let id = req.params.id;
    try {
        let result= await currencyRatesService.delete( id );
